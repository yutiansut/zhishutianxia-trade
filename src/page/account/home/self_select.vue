...
export default {
  ...
  data () {
    return {
      ...
      isLogin: true,
      list:['自选管理', '比赛记录', '个人设置', '客服中心', '帮助文档', '新闻公告']
    }
  },
  computed: {
      clientHeight () {
...
.icon{
    ...
    width: 0.32rem;
    height: 0.32rem;
    background: url('../../../assets/images/account/massage_info.png') center no-repeat;
...
.list_wrap{
    ...
    @for $i from 1 through 6 {
        $background_img: ("self_choose_icon", "home_match_icon", "home_self_icon", "home_customer_icon", "home_help_icon", "home_note_icon");
        .item:nth-child(#{$i}){
            .icon{
